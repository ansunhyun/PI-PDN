...
def _assign_pin_pair_rlc(
    comp: object,
    pin_pairs: list[tuple[str, str]],
    r_ohm: float,
    *,
    r_edb_input: str | None = None,
) -> None:
    ...
    # Customer-strict Arrays pass a canonical engineering-unit string such as
    # ``10kOhm``. Legacy Array handling and two-pin Series shorts intentionally
    # retain the numeric path.
    r_val = comp._get_edb_value(r_edb_input if r_edb_input is not None else r_ohm)
