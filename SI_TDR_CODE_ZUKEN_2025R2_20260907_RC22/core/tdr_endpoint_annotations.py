...
# 2026-08-26 AEDT 2025 R2 1400x800 HDMI/DP 실물 검증값(32pt Arial Bold).
# RefDes는 plot 아래 모서리 안쪽에 두고, 우측 글자는 길이만큼 왼쪽으로 보정한다.
NATIVE_REPORT_NOTE_X_MAX = 9550
NATIVE_REPORT_NOTE_BOTTOM_Y = 7450
NATIVE_REPORT_NOTE_ROW_STEP_Y = 1100
NATIVE_REPORT_NOTE_CHAR_WIDTH_AT_32PT = 150
