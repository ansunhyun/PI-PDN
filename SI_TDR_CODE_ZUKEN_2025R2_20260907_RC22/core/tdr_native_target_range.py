...
NOTE_X = 650
# 24pt 제목과 plot 상단선 사이에 끼지 않도록 첫 라벨을 한 행 아래에 둔다.
NOTE_TOP_Y = 900
NOTE_ROW_STEP_Y = 520
NOTE_FONT_SIZE_PT = 20
LIMIT_LINE_STYLE = "Dash"
LIMIT_LINE_WIDTH = 3
LIMIT_LINE_HATCH_PIXELS = 0
                ...
                rendered_lines.append(
                    {
                        ...
                        "hatchPixels": LIMIT_LINE_HATCH_PIXELS,
                    }
                )
                limit_line_count += 1
